            ...
            <Container fluid className="d-block align-items-center" style={{
                ...
                <Row style={{height: "100%"}} className="align-items-center">
                    <Col className="col-12 d-flex justify-content-center p-5" >
                        <h1 className="text-white align-self-center text-center col-8"  style={{paddingTop: "150px"}}>Book your free initial consultation today and take the first step towards a healthier smile!</h1>
                    </Col>
